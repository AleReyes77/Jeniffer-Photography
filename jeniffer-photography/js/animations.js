...
function initQuantumCarousel() {
    ...
    items.forEach((item, index) => {
        ...
        const translateZ = 600; // Radio del carrusel
        
        item.style.transform = `rotateY(${rotateY}deg) translateZ(${translateZ}px)`;
        
        // Efecto de parallax al hacer hover
        item.addEventListener('mousemove', (e) => {
            ...
            item.style.transform = `rotateY(${rotateY}deg) translateZ(${translateZ}px) rotateX(${rotateX}deg)`;
        });
